...
$versionBuild = "$versionFolder\versionBuild"; $versionBuildContents = ([IO.File]::ReadAllText($versionBuild)).Trim()
$versionTag = "$versionFolder\versionTag"; $versionTagContents = ([IO.File]::ReadAllText($versionTag)).Trim()
